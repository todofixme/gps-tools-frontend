...
import { useAppContext, useLanguage, useUploadContext } from '../../hooks'
import { useNavigate } from '@tanstack/react-router'
import { UploadedFile } from '../../@types/upload.ts'

export const MergeFiles = () => {
  const { uploadedFiles, setUploadedFiles, removeUploadedFile, mergeFiles } = useUploadContext()
  const { getMessage, language } = useLanguage()
  ...
  const handleUpload = async () => {
    ...
    await navigate({ to: `/${language}${redirectPath}` as never })
