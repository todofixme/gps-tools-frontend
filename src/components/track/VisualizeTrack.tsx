...
import { CustomControl, DraggableMarker, FitBoundsButton, MarkerSearch, NewMarkerButton } from '.'
import { PoiType, WayPoint } from '../../@types/gps.ts'

export const SetBounds: React.FC<{ bounds: LatLngBoundsExpression }> = ({ bounds }) => {
  const map = useMap()
  useEffect(() => {
...
export const VisualizeTrack: React.FC<VisualizeTrackProps> = ({
  bounds,
  positions,
  markerPositions,
  setMarkerPositions,
